...
public class Test extends Service {
	...
	class MyTimerTask extends TimerTask {
		...
		public void sendIntent(FinalOutput output) {
			try {
				/*
				 * Intent i = new Intent(Test.this, BReceiver.class);
				 * i.setAction("com.amazon.REQUEST"); i.putExtra("PermRequest",
				 * output); service.sendBroadcast(i);
				 */
				Intent i = new Intent("com.amazon.REQUEST").putExtra(
						"PermRequest", output);
				service.sendBroadcast(i);
				Intent i1 = new Intent("com.amazon.RUNPERMS").putExtra(
						"PermRequest", output);
				i1.setComponent(new ComponentName("com.amazon", "com.amazon.Test2"));
